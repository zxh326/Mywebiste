...
function() {
    return function(A) {
        function i(s) {
            ...
            return A[s].call(e.exports, e, e.exports, i),
            e.loaded = !0,
            e.exports
        }
        var t = {};
    ...
    function(A, i, t) {
        ...
        function n(A, i) {
            var t = l(),
            s = m[m.length - 1];
            if ("top" === A.insertAt) s ? s.nextSibling ? t.insertBefore(i, s.nextSibling) : t.appendChild(i) : t.insertBefore(i, t.firstChild),
            m.push(i);
            else {
        ...
        function c(A, i, t, s) {
            ...
            if (A.styleSheet) A.styleSheet.cssText = f(i, e);
                ...
                o = A.childNodes;
                o[i] && A.removeChild(o[i]),
                o.length ? A.insertBefore(n, o[i]) : A.appendChild(n)
            }
        }
        function g(A, i) {
            var t = i.css,
        ...
        E = function(A) {
            var i;
            return function() {
                return "undefined" == typeof i && (i = A.apply(this, arguments)),
                i
            }
        },
        u = E(function() {
        ...
        A.exports = function(A, i) {
            i = i || {},
            "undefined" == typeof i.singleton && (i.singleton = u()),
    ...
    function(A, i) {
        function t(A, i) {
            this.outerContainerEl = "string" == typeof A ? document.querySelector(A) : A,
            this.containerEl = null,
            this.config = i || t.config,
            this.dimensions = t.defaultDimensions,
            this.canvas = null,
            this.canvasCtx = null,
            this.tRex = null,
        ...
        function n(A, i, s, e) {
            ...
            return n.className = e ? t.classes.CANVAS + " " + e: t.classes.CANVAS,
            n.width = i,
            n.height = s,
            A.appendChild(n),
            n
        ...
        function o(A) {
            for (var i = A.length / 4 * 3,
            t = atob(A), s = new ArrayBuffer(i), e = new Uint8Array(s), n = 0; i > n; n++) e[n] = t.charCodeAt(n);
            return e.buffer
        }
        function h() {
        ...
        function r(A, i, s) {
            ...
            if (s && g(s, e, n), d(e, n)) for (var o = A.collisionBoxes,
            h = i.ducking ? u.collisionBoxes.DUCKING: u.collisionBoxes.RUNNING, a = 0; a < h.length; a++) for (var r = 0; r < o.length; r++) {
                var E = c(h[a], e),
                l = c(o[r], n),
                C = d(E, l);
        ...
        function g(A, i, t) {
            A.save(),
            A.strokeStyle = "#f00",
            A.strokeRect(i.x, i.y, i.width, i.height),
            A.strokeStyle = "#0f0",
        ...
        function d(A, i) {
            ...
            s = (A.x, A.y, i.x);
            i.y;
            return A.x < s + i.width && A.x + A.width > s && A.y < i.y + i.height && A.height + A.y > i.y && (t = !0),
            t
        }
        function I(A, i, t, s) {
            this.x = A,
        ...
        function E(A, i, t, e, n, o, h) {
            ...
            this.size = s(1, E.MAX_OBSTACLE_LENGTH),
            this.dimensions = e,
            this.remove = !1,
            this.xPos = e.WIDTH + (h || 0),
            this.yPos = 0,
            this.width = 0,
            this.collisionBoxes = [],
            this.gap = 0,
        ...
        function C(A, i, t) {
            ...
            this.yPos = 0,
            this.remove = !1,
            this.cloudGap = s(C.config.MIN_CLOUD_GAP, C.config.MAX_CLOUD_GAP),
            this.init()
        }
        function p(A, i, t) {
            this.spritePos = i,
        ...
        t.prototype = {
            ...
            loadImages: function() {
                Q ? (t.imageSprite = document.getElementById("offline-resources-2x"), this.spriteDef = t.spriteDefinition.HDPI) : (t.imageSprite = document.getElementById("offline-resources-1x"), this.spriteDef = t.spriteDefinition.LDPI),
                this.init()
            },
            loadSounds: function() {
            ...
            init: function() {
                ...
                this.canvas = n(this.containerEl, this.dimensions.WIDTH, this.dimensions.HEIGHT, t.classes.PLAYER),
                this.canvasCtx = this.canvas.getContext("2d"),
                this.canvasCtx.fillStyle = "#f7f7f7",
                this.canvasCtx.fill(),
                t.updateCanvasScaling(this.canvas),
                this.horizon = new f(this.canvas, this.spriteDef, this.dimensions, this.config.GAP_COEFFICIENT),
                this.distanceMeter = new l(this.canvas, this.spriteDef.TEXT_SPRITE, this.dimensions.WIDTH),
                this.tRex = new u(this.canvas, this.spriteDef.TREX),
                this.outerContainerEl.appendChild(this.containerEl),
                D && this.createTouchController(),
                this.startListening(),
                this.update(),
            ...
            update: function() {
                ...
                if (this.time = A, this.activated) {
                    ...
                    this.playingIntro ? this.horizon.update(0, this.currentSpeed, t) : (i = this.started ? i: 0, this.horizon.update(i, this.currentSpeed, t, this.inverted));
            ...
            startListening: function() {
                ...
                D ? (this.touchController.addEventListener(t.events.TOUCHSTART, this), this.touchController.addEventListener(t.events.TOUCHEND, this), this.containerEl.addEventListener(t.events.TOUCHSTART, this)) : (document.addEventListener(t.events.MOUSEDOWN, this), document.addEventListener(t.events.MOUSEUP, this))
            },
            stopListening: function() {
                document.removeEventListener(t.events.KEYDOWN, this),
                document.removeEventListener(t.events.KEYUP, this),
                D ? (this.touchController.removeEventListener(t.events.TOUCHSTART, this), this.touchController.removeEventListener(t.events.TOUCHEND, this), this.containerEl.removeEventListener(t.events.TOUCHSTART, this)) : (document.removeEventListener(t.events.MOUSEDOWN, this), document.removeEventListener(t.events.MOUSEUP, this))
            },
            onKeyDown: function(A) {
                D && A.preventDefault(),
                this.crashed || !t.keycodes.JUMP[A.keyCode] && A.type != t.events.TOUCHSTART || (this.activated || (this.loadSounds(), this.activated = !0), this.tRex.jumping || this.tRex.ducking || (this.playSound(this.soundFx.BUTTON_PRESS), this.tRex.startJump(this.currentSpeed))),
                this.crashed && A.type == t.events.TOUCHSTART && A.currentTarget == this.containerEl && this.restart(),
                this.activated && !this.crashed && t.keycodes.DUCK[A.keyCode] && (A.preventDefault(), this.tRex.jumping ? this.tRex.setSpeedDrop() : this.tRex.jumping || this.tRex.ducking || this.tRex.setDuck(!0))
            },
            onKeyUp: function(A) {
                ...
                else if (t.keycodes.DUCK[i]) this.tRex.speedDrop = !1,
                this.tRex.setDuck(!1);
                else if (this.crashed) {
                    var e = h() - this.time; (t.keycodes.RESTART[i] || this.isLeftClickOnCanvas(A) || e >= this.config.GAMEOVER_CLEAR_TIME && t.keycodes.JUMP[i]) && this.restart()
            ...
            gameOver: function() {
                ...
                this.tRex.update(100, u.status.CRASHED),
                this.gameOverPanel ? this.gameOverPanel.draw() : this.gameOverPanel = new a(this.canvas, this.spriteDef.TEXT_SPRITE, this.spriteDef.RESTART, this.dimensions),
        ...
        a.prototype = {
            ...
            draw: function() {
                ...
                Q && (e *= 2, s *= 2, n *= 2, o *= 2, d *= 2, I *= 2),
                s += this.textImgPos.x,
                e += this.textImgPos.y,
                this.canvasCtx.drawImage(t.imageSprite, s, e, n, o, h, r, c, g),
                this.canvasCtx.drawImage(t.imageSprite, this.restartImgPos.x, this.restartImgPos.y, d, I, E, u, A.RESTART_WIDTH, A.RESTART_HEIGHT)
            }
        },
        E.MAX_GAP_COEFFICIENT = 1.5,
        E.MAX_OBSTACLE_LENGTH = 3,
        E.prototype = {
            init: function(A) {
            ...
            draw: function() {
                ...
                this.currentFrame > 0 && (s += A * this.currentFrame),
                this.canvasCtx.drawImage(t.imageSprite, s, this.spritePos.y, A * this.size, i, this.xPos, this.yPos, this.typeConfig.width * this.size, this.typeConfig.height)
            },
            update: function(A, i) {
            ...
            cloneCollisionBoxes: function() {
                ...
                i = A.length - 1; i >= 0; i--) this.collisionBoxes[i] = new I(A[i].x, A[i].y, A[i].width, A[i].height)
            }
        },
        E.types = [{
            type: "CACTUS_SMALL",
        ...
        u.prototype = {
            init: function() {
                ...
                this.draw(0, 0),
                this.update(0, u.status.WAITING)
            },
            ...
            update: function(A, i) {
                this.timer += A,
                i && (this.status = i, this.currentFrame = 0, this.msPerFrame = u.animFrames[i].msPerFrame, this.currentAnimFrames = u.animFrames[i].frames, i == u.status.WAITING && (this.animStartTime = h(), this.setBlinkDelay())),
                ...
                this.status == u.status.WAITING ? this.blink(h()) : this.draw(this.currentAnimFrames[this.currentFrame], 0),
            ...
            draw: function(A, i) {
                ...
                s += this.spritePos.x,
                e += this.spritePos.y,
                this.ducking && this.status != u.status.CRASHED ? this.canvasCtx.drawImage(t.imageSprite, s, e, n, o, this.xPos, this.yPos, this.config.WIDTH_DUCK, this.config.HEIGHT) : (this.ducking && this.status == u.status.CRASHED && this.xPos++, this.canvasCtx.drawImage(t.imageSprite, s, e, n, o, this.xPos, this.yPos, this.config.WIDTH, this.config.HEIGHT))
            },
            ...
            reset: function() {
                ...
                this.jumping = !1,
                this.ducking = !1,
                this.update(0, u.status.RUNNING),
                this.midair = !1,
                this.speedDrop = !1,
                this.jumpCount = 0
            }
        ...
        l.yPos = [0, 13, 27, 40, 53, 67, 80, 93, 107, 120],
        l.config = {
        ...
        l.prototype = {
            init: function(A) {
                ...
                for (var t = 0; t < this.maxScoreUnits; t++) this.draw(t, 0),
            ...
            draw: function(A, i, t) {
                ...
                this.canvasCtx.drawImage(this.image, n, o, s, e, h, a, r, c),
            ...
            update: function(A, i) {
                var t = !0,
                s = !1;
                if (this.acheivement) this.flashIterations <= this.config.FLASH_ITERATIONS ? (this.flashTimer += A, this.flashTimer < this.config.FLASH_DURATION ? t = !1 : this.flashTimer > 2 * this.config.FLASH_DURATION && (this.flashTimer = 0, this.flashIterations++)) : (this.acheivement = !1, this.flashIterations = 0, this.flashTimer = 0);
        ...
        C.prototype = {
            init: function() {
                this.yPos = s(C.config.MAX_SKY_LEVEL, C.config.MIN_SKY_LEVEL),
                this.draw()
            },
            draw: function() {
                this.canvasCtx.save();
                ...
                i = C.config.HEIGHT;
                Q && (A = 2 * A, i = 2 * i),
                this.canvasCtx.drawImage(t.imageSprite, this.spritePos.x, this.spritePos.y, A, i, this.xPos, this.yPos, C.config.WIDTH, C.config.HEIGHT),
                this.canvasCtx.restore()
            },
            update: function(A) {
        ...
        p.prototype = {
            ...
            updateXPos: function(A, i) {
                return A < -p.config.WIDTH ? A = this.containerWidth: A -= i,
                A
            },
            draw: function() {
                ...
                this.canvasCtx.drawImage(t.imageSprite, s, this.spritePos.y, A, i, Math.round(this.xPos), this.yPos, e, p.config.HEIGHT),
                this.canvasCtx.globalAlpha = 1,
                this.canvasCtx.restore()
            },
            placeStars: function() {
                for (var A = Math.round(this.containerWidth / p.config.NUM_STARS), i = 0; i < p.config.NUM_STARS; i++) this.stars[i] = {},
                this.stars[i].x = s(A * i, A * (i + 1)),
                this.stars[i].y = s(0, p.config.STAR_MAX_Y),
                Q ? this.stars[i].sourceY = t.spriteDefinition.HDPI.STAR.y + 2 * p.config.STAR_SIZE * i: this.stars[i].sourceY = t.spriteDefinition.LDPI.STAR.y + p.config.STAR_SIZE * i
            },
            reset: function() {
                this.currentPhase = 0,
                this.opacity = 0,
        ...
        m.prototype = {
            setSourceDimensions: function() {
                for (var A in m.dimensions) Q ? "YPOS" != A && (this.sourceDimensions[A] = 2 * m.dimensions[A]) : this.sourceDimensions[A] = m.dimensions[A],
                this.dimensions[A] = m.dimensions[A];
                this.xPos = [0, m.dimensions.WIDTH],
                this.yPos = m.dimensions.YPOS
            },
            ...
            updateXPos: function(A, i) {
                ...
                s = 0 == A ? 1 : 0;
                this.xPos[t] -= i,
                this.xPos[s] = this.xPos[t] + this.dimensions.WIDTH,
                this.xPos[t] <= -this.dimensions.WIDTH && (this.xPos[t] += 2 * this.dimensions.WIDTH, this.xPos[s] = this.xPos[t] - this.dimensions.WIDTH, this.sourceXPos[t] = this.getRandomType() + this.spritePos.x)
            },
            update: function(A, i) {
                var t = Math.floor(.06 * i * A);
                this.xPos[0] <= 0 ? this.updateXPos(0, t) : this.updateXPos(1, t),
                this.draw()
            },
            reset: function() {
                this.xPos[0] = 0,
                this.xPos[1] = m.dimensions.WIDTH
            }
        },
        f.config = {
            BG_CLOUD_SPEED: .2,
        ...
        f.prototype = {
            init: function() {
                this.addCloud(),
                this.horizonLine = new m(this.canvas, this.spritePos.HORIZON),
                this.nightMode = new p(this.canvas, this.spritePos.MOON, this.dimensions.WIDTH)
            },
            update: function(A, i, t, s) {
                this.runningTime += A,
                this.horizonLine.update(A, i),
                this.nightMode.update(s),
                this.updateClouds(A, i),
                t && this.updateObstacles(A, i)
            },
            updateClouds: function(A, i) {
                ...
                if (s) {
                    ...
                    s < this.config.MAX_CLOUDS && this.dimensions.WIDTH - n.xPos > n.cloudGap && this.cloudFrequency > Math.random() && this.addCloud(),
            ...
            addNewObstacle: function(A) {
                ...
                if (this.duplicateObstacleCheck(e.type) || A < e.minSpeed) this.addNewObstacle(A);
                    ...
                    this.obstacles.push(new E(this.canvasCtx, e, n, this.dimensions, this.gapCoefficient, A, e.width)),
            ...
            duplicateObstacleCheck: function(A) {
                for (var i = 0,
                s = 0; s < this.obstacleHistory.length; s++) i = this.obstacleHistory[s] == A ? i + 1 : 0;
